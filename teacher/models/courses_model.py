...
class Course(models.Model):
    ...
    teacher_category = models.CharField(max_length=191, null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        SystemNotification.objects.create(user = self.teacher, notification = f'Congratulation, Your course {self.title} has been created successfully.')
