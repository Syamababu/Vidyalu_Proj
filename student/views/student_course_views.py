...
from student.serializers.student_course_serializer import CourseDetailSerializer,OneCourseDetailSerializer, OneCourseDetailOnlySerializer
        ...
        try:
            ...
            if course:
                ...
                if user.role == 'teacher' or user.role == 'counsellor':
                    ...
                    # print(serializer.data['is_booking'])
...
class StudentCourseDetailsOnlyView(APIView):
    """
            student can view single course details.
    """
    # permission_classes = (IsAuthenticated,)
    ...
    def post(self, request):
        try:
            ...
            if course:
                ...
                serializer = OneCourseDetailOnlySerializer(course)#context={"user_id":request.user.id}
                # if user.role == 'teacher' or user.role == 'counsellor':
                #     serialized_data = serializer.data
                #     serialized_data['is_booking'] = True
                #     # print(serializer.data['is_booking'])
