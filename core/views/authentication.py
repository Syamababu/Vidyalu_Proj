...
class RegisterAPI(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return api_response(201, "An activation link has been sent to your email. Please verify.", serializer.data, status=True)
        else:
    ...
    def get(self, request, uidb64="0000", token=None):
        try:
            ...
            if not PasswordResetTokenGenerator().check_token(user, token):
                ...
                user.save()
                SystemNotification.objects.create(user = user, notification = "Congratulation, Successfully your account has been created")
...
class RequestPasswordResetEmail(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        if User.objects.filter(email=email).exists():
            ...
            subject = "Reset Your Vidyalu Passsword"
            body = "Dear" +" "+user.username +"\n"+"\n"+ "To reset your password, please click the following link:\n" +"\n"+ absurl+"\n"+"\n"+"If you didn't request password reset, please contact Vidyalu IT Support (https://vidyalu.myvtd.site/help-support). Please do not reply to this email."
