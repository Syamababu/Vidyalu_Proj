...
class Session(models.Model):
    ...
    counsellor_category = models.CharField(max_length=191, null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        SystemNotification.objects.create(user = self.counsellor , notification = f'Congratulation, Your session {self.title} has been created successfully.')
